...
public class ProductMasterViewModel : IViewModel, IProductMasterViewModel
{
    ...
    private void StoreProduct()
    {
        Task.Run(async () =>
        {
            ...
            await _modelOperation.AddAsync(lastId, RoomNumber, RoomType, IsBooked);
    ...
    private async void LoadProducts()
    {
        ...
        Application.Current.Dispatcher.Invoke(() =>
        {
            ...
            {
                _products.Add(new ProductDetailViewModel(p.Id, p.RoomNumber, p.RoomType, p.isBooked));
            }
        });
