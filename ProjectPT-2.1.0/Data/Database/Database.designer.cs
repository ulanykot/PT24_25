...
namespace Data.Database
{
    ...
    partial void OnIdChanging(int value);
    partial void OnIdChanged();
    partial void OnRoomCatalogIdChanging(int value);
    ...
    partial void OnPriceChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_RoomCatalogId", DbType="Int NOT NULL")]
		...
		public Catalog Catalog
		{
			...
			set
			{
							...
							|| (this._Catalog.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._RoomCatalogId = default(int);
					}
